        ...
        <div class="return-invoice-list">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/return-nvoice/all/list" method="GET">
                        @csrf
                    ...
                    @if ($title == "All Return Invoice In Pharmacy")
                    <form action="/return-nvoice/all-in-pharmacy/list" method="GET">
                        @csrf
                        <div class="row form-search-date">
                            <div class="col-lg-5 col-md-12">
                                <div class="input-group mb-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                     ...
                                     @endif
                                        <a href="/return-invoice/show-details/{{ $invoice->id }}" title="Display"><i class="fa fa-eye"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
