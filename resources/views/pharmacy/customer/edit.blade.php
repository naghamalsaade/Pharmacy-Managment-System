...
<head>
    ...
    <title>Edit Customer's Informations</title>
        ...
        <div class="add-customer">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="needs-validation" action="{{route('customer.update',$customer->id)}}" method="POST" novalidate>
                                    @csrf
                                <div class="col">
                                ...
                                <div class="col">
                                    <input type="text"  value="{{$customer->mobile}}" class="form-control input" minlength="10" onkeypress="return onlyNumberKey(event)" name="phone">
                                    <span class="focus-input" ></span>
                                </div>
                                <div class="form-row">
                                    <div class="col-lg-9">
