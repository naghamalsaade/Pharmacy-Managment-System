            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight">
                        ...
                        <a href="/return-invoice/show-return-cart"><button type="button" class="btn btn-list"><i class="fa fa-plus-square-o"></i>&nbsp; Add Return Invoice</button></a>
                    </div>
                </div>
                <div class="card-body">
                    <table id="table" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                <form action="{{route('invoiceReturn',$one->id )}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <input type="decimal" class="form-control-input" name="num_return">
                                        <input type="submit" class="btn btn-list input-custom" name="return" value="return">
                                    </div>
                                </form>
                                </td>
                                <td>
                                    <div class="row" style="margin-left: 15px;">
                                        <a href="/invoice/show-details/{{$one->invoice_id}}" title="Display Invoice"><i class="fas fa-expand-arrows-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
