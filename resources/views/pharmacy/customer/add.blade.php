            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                       Add Customer
                        <a href="{{asset('/customer/all')}}"><button type="button" class="btn btn-list">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="needs-validation" action= "{{route('customer.store')}}" method="POST" novalidate>
                                ...
                                <div class="col">
                                    <input type="text" class="form-control input" minlength="10" onkeypress="return onlyNumberKey(event)" name="phone">
