        ...
        <div class="display-invoice">
                <div class="card-header card-invoice d-flex justify-content-between bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight">
                        <a href="/invoice/all-in-pharmacy/list"><button type="button" class="btn btn-list"><i class="fa fa-align-justify"></i> &nbsp;Invoice List</button></a>
                        <a href="/invoice/print-invoice/{{$invoice->id}}"><button type="button" class="btn btn-list"><i class="fa fa fa-print"></i> &nbsp;Print</button></a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="invoice-details">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($invoice->invoiceProduct()->get() as $item)
                                <tr>
