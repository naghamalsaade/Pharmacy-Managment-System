        ...
        <div class="display-invoice">
                <div class="card-header card-invoice d-flex justify-content-between bd-highlight mb-3">
                    ...
                    <div class="p-2 bd-highlight">
                        <a href="invoice_list.html"><button type="button" class="btn btn-list"><i class="fa fa-align-justify"></i> &nbsp;Invoice List</button></a>
                        <a href="/Invoice/print_invoice"><button type="button" class="btn btn-list"><i class="fa fa fa-print"></i> &nbsp;Print</button></a> 
                    </div>
                </div>
