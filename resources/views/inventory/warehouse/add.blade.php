            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        Add Warehouse
                        <a href="/warehouse/all"><button type="button" class="btn btn-list">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="needs-validation" novalidate method="POST" action="{{route('warehouse.store')}}">                              {{ csrf_field() }}
                                @csrf
                                <div class="col">
                        ...
                        <div class="col-lg-6 d-none d-xl-block d-lg-block">
                            <img src="{{asset('img/add_manufacturer.jpg')}}" class="img-thumbnail">
