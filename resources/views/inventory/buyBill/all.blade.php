...
<head>
    ...
    <title>Received Order List</title>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @if ($title == "Received Order List In Inventory")
                        <a href="/order/add"><button type="button" class="btn add-up"><i class="fa fa-plus-square-o"></i>&nbsp; Add Order To Warehouse</button></a>
                        @endif
                ...
                <div class="card-body">
                    ...
                    @if ($title == "All Buy Bills | Received Order")
                    <form action="/buy-bill/all" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                    ...
                    @if ($title == "Received Order List In Inventory")
                    <form action="/buy-bill/all-in-inventory" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="row form-search-date">
                            <div class="col-lg-5 col-md-12">
                                <div class="input-group mb-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text paid_amount" id="paid_amount" name="paid_amount"> {{$one->total_price - $one->total_payment}}</div>
                                        </div>
                                        <button type="submit" class="btn btn-list" data-toggle="modal" data-target="#paidModal" aria-describedby="btnGroupAddon">Paid</button>
                                    </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('payment.store', $one->id)}}" method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            <input type="text" class="form-control paid" name="payment"  placeholder="Payment Amount">
                                                        </div>
                                                        <div class="row">
                                                            <input class="form-control paid" id="Date" name="date" data-provide="datepicker" required data-date-format="yyyy-mm-dd" placeholder="Payment Date">
                                                        </div>
                                                        <button type="submit" class="btn btn-list float-right" style="font-size: 15px; ">Paid</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <td>
                                    <div class="row">
                                        <a href="/buy-bill/products/{{$one->id}}" title="receved products"><i class="fas fa-cart-arrow-down" aria-hidden="true"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
