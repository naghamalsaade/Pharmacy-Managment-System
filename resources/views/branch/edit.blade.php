            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        Edit Branch
                        <a href="/branch/all"><button type="button" class="btn btn-list">
                        ...
                        <div class="col-lg-6">
                            <form action="{{route('branch.update',$branch->id)}}" method="POST">
                                ...
                                <div class="form-row" style="margin-top: 30px;">
                                    ...
                                    <input type="text" value="{{$branch->name}}" class="form-control2 col-lg-9" id="name" placeholder="Name" name="name" required>
                                </div>
                                <div class="form-row">
                                    <label for="email" class="col-lg-2 label-input">E-mail:</label>
                                    <input type="email" value="{{$branch->email}}" class="form-control2 col-lg-9" id="email" placeholder="E-mail" name="email" required>
                                </div>
                                <div class="form-row">
                                    <label class="col-lg-2 col-md-3  label-input">Location:</label>
                                    <select class="selectpicker col-lg-9" data-live-search="true" name="Location">
                                        <option value={{$branch->location_id}}>Nothing selected{{__('message.')}}</option>
