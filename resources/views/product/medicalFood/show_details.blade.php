            ...
            <div class="card">
                <div class="card-header  d-flex justify-content-between bd-highlight mb-3">
                    <div class="p-2 bd-highlight">
                       {{__('messages.Details_Medical_Food')}}
                    </div>
                    <div class="p-2 bd-highlight">
                        <a href="/medical-food/food-grid-in-pharmacy"><button type="button" class="btn btn-list"><i class="	fa fa-th"></i> &nbsp{{__('messages.grid')}}</button></a>
                        <a href="/medical-food/create"><button type="button" class="btn btn-list"><i class="fa fa-plus-square-o"></i> &nbsp;{{__('messages.add_food')}}</button></a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="" style="margin-left: 60px; margin-top: 20px; ">
                            <div class="row-details">
                                ...
                                <label> &nbsp;{{__('messages.Medical_Food_Name')}}
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> {{__('messages.adverse_effects')}}:
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;{{__('messages.ware_house')}}:
                                    <label class="value">{{$detail -> name_warehouse}}</label>
                                </label>
                                <br>
                            </div>
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;{{__('messages.purchasing_price')}}:
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;{{__('messages.production_date')}}:
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;{{__('messages.expired_date')}}:
                            ...
                            <div class="row-details">
                                <i class="fa fa-chevron-circle-right"></i>
                                <label> &nbsp;{{__('messages.product_country')}}:
