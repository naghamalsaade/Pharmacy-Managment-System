            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('medicalFood.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control col-lg-3" id="FoodName" placeholder="Name" name="name" required>
                        <div class="col-lg-1"></div>
                        <label for="Manufacturer" class="col-lg-2 label-input">Manufacturer</label>
                        <input type="text" name="manufacturer_company" class="form-control  col-lg-3" id="Manufacturer"  placeholder="Manufacturer" required>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control col-lg-3" id="Storage" placeholder="Storage" name="storage" required>
                        <div class="col-lg-1"></div>
                        <label for="AdverseEffects" class="col-lg-2 label-input">Adverse Effects</label>
                        <input type="text" name="adverse_effects" class="form-control  col-lg-3" id="Adverse Effects" placeholder="Adverse Effects" required>
                    </div>
