            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                    <div class="p-2 bd-highlight">
                       {{__('messages.display_food_batches')}}
                    </div>
                ...
                <div class="card-body">
                    <table id="table" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <thead>
                            ...
                            <tr>
                                <th scope="col">{{__('messages.Batch_Id')}}</th>
                                <th scope="col">{{__('messages.name')}}</th>
                                <th scope="col">{{__('messages.amount')}}</th>
                                <th scope="col">{{__('messages.ware_house')}}</th>
                                ...
                                <th scope="col">{{__('messages.drawer')}}</th>
                                <th scope="col">{{__('messages.batch_date')}}</th>
                        ...
                        @foreach($batches as $batch)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <a href="{{asset('medical-food/show-details/'. $batch ->id)}}" title="Display"><i class="fas fa-expand-arrows-alt"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
