    ...
    <div class="add-medicalDevices">
        <div class="card">
            <div class="card-header d-flex justify-content-between bd-highlight mb-3">
                ...
                <div class="p-2 bd-highlight">
                    <a href="/medical_supply/all"><button type="button" class="btn btn-list"><i
            ...
            <div class="card-body">
                <form method="POST" action="{{route('medicalSupply.update', $medicalSupply -> id)}}"  enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control col-lg-3" id="DeviceName" value="{{$medicalSupply->name}}" required name="name">
                        <div class="col-lg-1"></div>
                        <label for="Manufacturer" class="col-lg-2 label-input">Manufacturer:</label>
                        <input type="text" class="form-control  col-lg-3" id="Manufacturer" value="{{$medicalSupply-> product -> manufacturer_company}}" name="manufacturer_company">
                    </div>

                    <div class="form-row">
                        <label for="ProductCountry" class="col-lg-2 label-input">Product Country:</label>
                        <input type="text" class="form-control col-lg-3" id="ProductCountry" value="{{$medicalSupply-> product -> product_country}}" name="product_country">
                        <div class="col-lg-1"></div>
